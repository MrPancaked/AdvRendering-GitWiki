...
The particle Simulation runs smoothly up to around 3000 particles under most standard simulation parameters. Beyond this amount the simulation clearly struggles to stabilize itself both in fps and simulation state, hinting at a need for more optimisations.
